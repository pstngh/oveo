"""Repair databases stamped with the three-section revision but retaining legacy constraints.
...
def downgrade() -> None:
    # Revision 0002 specifies the same final constraints. Removing this repair marker
    # must therefore leave the repaired schema intact.
    pass
